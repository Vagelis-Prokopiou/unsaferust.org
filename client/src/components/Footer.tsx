        ...
        <div class="bg-gray-100 dark:bg-gray-800">
            <div
                ...
                <div class="w-48 text-gray-700 dark:text-gray-200">
                    <div>
                        <p class="text-center lg:text-left text-gray-500 dark:text-gray-300">unsaferust.org</p>
                    </div>
                </div>
                <p class="text-sm text-gray-500 dark:text-gray-300">{(new Date().getFullYear())}. All Rights
                    Reserved.</p>
                <div class="flex items-center space-x-6">
                    {/*<a href="/legal" class="text-sm text-gray-500 transition-colors duration-300 dark:text-gray-300 hover:underline hover:text-primary dark:hover:text-primary">Todo</a>*/}
                    <a href="https://twitter.com/VProkopiou" target="_blink"
                    ...
                    </a> <a href="https://github.com/Vagelis-Prokopiou/unsaferust.org" target="_blink"
                            class="text-gray-500 transition-colors duration-300 dark:text-gray-300 hover:text-primary dark:hover:text-primary">
